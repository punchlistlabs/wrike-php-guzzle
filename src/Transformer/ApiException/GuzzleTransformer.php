...
namespace TripleNerdScore\WrikePhpGuzzle\Transformer\ApiException;

use GuzzleHttp\Exception\BadResponseException;
use TripleNerdScore\WrikePhpLibrary\Exception\Api\ApiException;
use TripleNerdScore\WrikePhpLibrary\Transformer\ApiException\AbstractApiExceptionTransformer;
